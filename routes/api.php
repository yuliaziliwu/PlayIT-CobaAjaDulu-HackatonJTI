...
// Rute untuk Kategori
Route::get('/kategori/admin', [KategoriController::class, 'admin']);   
...
Route::get('/perangkat-listrik/admin', [PerangkatListrikController::class, 'admin']);
...
Route::get('/standar-listrik/admin', [StandarListrikController::class, 'admin']);
